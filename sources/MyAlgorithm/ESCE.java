	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting ESCE...");
			...
			Datacenter datacenter0 = createDatacenter("Datacenter_0");
	            	...
	            	ESCEBroker broker = createBroker();
...
//	            	cloudletList = new CloudletCreator().createUserCloudlet(reqTasks, brokerId1);
	    ...
	    private static ESCEBroker createBroker(){

	    	ESCEBroker broker = null;
	        try {
			broker = new ESCEBroker("Broker");
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
